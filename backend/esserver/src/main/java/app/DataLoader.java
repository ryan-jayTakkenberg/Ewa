...
public class DataLoader implements CommandLineRunner {
    ...
    private void createSampleOrders() {
        // Create Warehouse
        Warehouse warehouse1 = new Warehouse(1, "Warehouse solar", "Amsterdam", "Solar street 3", "3465LK");
        warehouseRepo.save(warehouse1);
        Warehouse warehouse2 = new Warehouse(2, "Warehouse green solar", "Amsterdam", "Solar street 14", "0349OP");
        warehouseRepo.save(warehouse1);
