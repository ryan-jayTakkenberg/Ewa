...
export default {
  ...
  methods: {
    saveProject() {
      ...
      console.log("Saving user:", this.editedProject);
      this.onClose();
    }
  },
  created() {
      this.editedProject = this.project.clone();
        ...
        <div class="modal-body">
          <div class="modal-grid">
            <div class="col-span-6 sm:col-span-3">
              ...
              <input type="text"
                     v-model="this.editedProject.projectName"
                     class="modal-input shadow-sm focus:ring-blue-600 focus:border-blue-600"
                     :placeholder="editedProject.projectName" required>
            </div>
            <div class="col-span-6 sm:col-span-3">
              <label for="email" class="modal-label">Client</label>
              <input
                  type="text"
                  v-model="this.editedProject.clientName"
                  class="modal-input shadow-sm focus:ring-blue-600 focus:border-blue-600"
                  required>
            </div>
            <div class="col-span-6 sm:col-span-3">
              <label for="dateOfInstallation" class="modal-label">DateOfInstallation</label>
              <input
                  type="date"
                  v-model="this.editedProject.installDate"
                  class="modal-input shadow-sm focus:ring-blue-600 focus:border-blue-600"
                  required
              >
            </div>
