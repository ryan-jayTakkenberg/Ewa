...
const CREATE_PRODUCT_BUTTON = 'Create New Product';
const ACTION_BUTTON = 'Action';

beforeEach(() => wrapper = mount(ProductOverview));
...
it('has create button', () => {
    ...
    const button = wrapper.findAll('button')
        .find(button => button.element.innerHTML?.toLowerCase().includes(CREATE_PRODUCT_BUTTON.toLowerCase()));
