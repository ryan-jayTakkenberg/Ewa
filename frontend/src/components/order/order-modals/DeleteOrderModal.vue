<template>
  <SolarModal title="Delete order" @close-modal="onClose">
    ...
    <template v-slot:footer>
      ...
      <button @click="deleteOrder" class="ml-auto delete-button">Delete Order</button>
    </template>
  </SolarModal>
</template>
...
export default {
  ...
  methods: {
    deleteOrder() {
      this.$emit('delete', this.order.id); // Emit an event to toggle the checked value
    },
  }
};
</script>
