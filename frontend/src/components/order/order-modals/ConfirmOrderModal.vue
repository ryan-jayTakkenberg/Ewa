<template>
  <SolarModal title="Complete order" @close-modal="onClose">
    ...
    <template v-slot:footer>
      ...
      <button @click="completeOrder" class="ml-auto delete-button">Complete Order</button>
    </template>
  </SolarModal>
</template>
...
export default {
  ...
  methods: {
    completeOrder() {
      this.$emit('complete', this.order.id); // Emit an event to toggle the checked value
    },
  }
};
</script>
